...
public class GeoValue implements WritableComparable {
	...
	public boolean equals(Object obj) {
		...
		if (this.eventDate != other.eventDate
				&& (this.eventDate == null || !this.eventDate
						.equals(other.eventDate))) {
			return false;
		}
		if (this.actor != other.actor
				&& (this.actor == null || !this.actor.equals(other.actor))) {
			return false;
		}
		...
		if (this.fatalities != other.fatalities
				&& (this.fatalities == null || !this.fatalities
						.equals(other.fatalities))) {
			return false;
		}
		return true;
	}
	...
	public int hashCode() {
		int hash = 5;
		hash = 29 * hash
				+ (this.eventDate != null ? this.eventDate.hashCode() : 0);
		hash = 29 * hash
				+ (this.eventType != null ? this.eventType.hashCode() : 0);
		hash = 29 * hash + (this.actor != null ? this.actor.hashCode() : 0);
		hash = 29 * hash + (this.source != null ? this.source.hashCode() : 0);
		hash = 29 * hash
				+ (this.fatalities != null ? this.fatalities.hashCode() : 0);
		return hash;
	}
